...
<div class="row">
	<div class="col-sm-12">
		<?php
			...
			?>
				<br><p class="lead"><button class="btn btn-default"><?php	echo '<a href="post_view.php?id='.$row['id'].'">Read More</a>'?></button></p>
				<ul class="list-inline"><li><?php?></li><li><a href="#"><i class="glyphicon glyphicon-comment"></i> <?php echo '<a href="post_view.php?id='.$row['id'].'#comments">'.$row['comments'].' comments</a>';?></a></li>
